...
while ($row = mysqli_fetch_assoc($select_comments)) {
    ...
    echo '<td class="text-center"><a href="comments.php?approve=' . $comment_id . '"><button class="btn btn-success btn-sm">Approve</button></a></td>';
    echo '<td class="text-center"><a href="comments.php?deny=' . $comment_id . '"><button class="btn btn-warning btn-sm">Deny</button></a></td>';
    echo '<td class="text-center"><a href="comments.php?delete=' . $comment_id . '"><button class="btn btn-danger btn-sm">Delete</button></a></td>';
    echo '</tr>';
}
